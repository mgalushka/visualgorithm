/*
 * PedagogicalTreeCreationPanel.java v1.00 07/07/08
 *
 * Visualgorithm
 ...
 */
class PedagogicalTreeCreationPanel extends JPanel {
    ...
    /**
     * Builds the pedagogical tree creation panel.
     * 
                            ...
                            if ((value.charAt(1) >= '0')
                                ...
                                if (pedagogicalTreeVisualization.isEmpty()) {
                                    ...
                                    pedagogicalTreeVisualization
                                            .createNode(Integer.parseInt(value));
                                }
                            }
                        }

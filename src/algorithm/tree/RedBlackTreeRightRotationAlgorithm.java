/*
 * RedBlackTreeRightRotationAlgorithm.java v1.00 03/04/10
 *
 * Visualgorithm
...
/**
 * This class defines the red black tree right rotation algorithm. It is
 * composed by the red black tree on which the algorithm is applied and the node
 * on which the rotation is applied.
 * 
...
public final class RedBlackTreeRightRotationAlgorithm extends AbstractBinaryTreeRightRotationAlgorithm {
     ...
     */
    public RedBlackTreeRightRotationAlgorithm(RedBlackTree t, RedBlackNode n) {
        super(t, n);
    }

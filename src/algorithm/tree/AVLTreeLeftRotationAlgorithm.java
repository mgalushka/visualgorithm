/*
 * AVLTreeLeftRotationAlgorithm.java v0.10 03/04/10
 *
 * Visualgorithm
...
/**
 * This class defines the AVL tree left rotation algorithm. It is composed
 ...
 */
public final class AVLTreeLeftRotationAlgorithm
        extends AbstractBinaryTreeLeftRotationAlgorithm<AVLNode, AVLTree> {

    /**
     * Builds the AVL tree left rotation algorithm.
     *
     * @param t the AVL tree on which the algorithm is applied
     * @param n the AVL node on which the rotation is applied
     */
    public AVLTreeLeftRotationAlgorithm(AVLTree t, AVLNode n) {
        super(t, n);
    }
